...
from wdic.views import ImportSessionView, SessionListView, SessionHandsView, HandDetailView, AnalyzeHandView, AnalyzeSessionView
...
urlpatterns = [
    ...
    path("sessions/<uuid:session_id>/analyze", AnalyzeSessionView.as_view(), name="wdic_session_analyze"),
