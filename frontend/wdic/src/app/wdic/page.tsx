      ...
      <div className="relative z-10 max-w-7xl mx-auto p-4 md:p-12">
        ...
        >
            <div className="flex items-center gap-6">
              <Link href="/" className="inline-flex items-center gap-2 group">
                  ...
                  <span className="text-sm font-black text-gray-500 group-hover:text-gray-900 transition-colors uppercase tracking-widest">{t("back")}</span>
              </Link>
            </div>
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-16 gap-12">
          <motion.div 
            ...
            className="max-w-2xl"
          >
            <h1 className="text-6xl md:text-7xl font-[1000] tracking-tighter mb-4 drop-shadow-sm text-gray-900 uppercase leading-[0.9]">
          ...
          >
            <div className="bg-white/60 backdrop-blur-xl rounded-[2.5rem] p-6 border border-white shadow-[0_20px_50px_rgba(0,0,0,0.04)] relative overflow-hidden group">
                ...
                <div className="relative z-10">
                  ...
                  <div 
                      ...
                      className={`
                        relative group border-2 border-dashed rounded-[2rem] p-8 transition-all duration-500 text-center cursor-pointer
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-20">
          ...
          />
          <StatCard 
            label={t("stats_active_platform")} 
            value={currentSourceStyle.label} 
            color="text-rose-500" 
